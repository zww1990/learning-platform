...
public class InstanceConfig {
	@Id
	@Column(name = "Id")
	@GeneratedValue(generator = "instanceconfig_seq", strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name = "instanceconfig_seq", sequenceName = "instanceconfig_seq", allocationSize = 1, initialValue = 1)
	private long id;
