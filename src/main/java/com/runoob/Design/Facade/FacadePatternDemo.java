 ...
 *         2、提高灵活性。 <br>
 *         3、提高了安全性。<br>
 *         缺点：不符合开闭原则，如果要改东西很麻烦，继承重写都不合适。<br>
 *         使用场景：<br>
 *         1、为复杂的模块或子系统提供外界访问的模块。<br>
 *         2、子系统相对独立。<br>
 *         3、预防低水平人员带来的风险。<br>
 *         注意事项：在层次化结构中，可以使用外观模式定义系统中每一层的入口。<br>
 */
public class FacadePatternDemo {
	/**
	 * 我们将创建一个 Shape 接口和实现了 Shape 接口的实体类。下一步是定义一个外观类 ShapeMaker。 ShapeMaker
	 * 类使用实体类来代表用户对这些类的调用。FacadePatternDemo，我们的演示类使用 ShapeMaker 类来显示结果。
	 */
