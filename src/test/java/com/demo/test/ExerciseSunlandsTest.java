...
//		cookies.add("Hm_lvt_042f1b4fd18a22ee217f0673c4c1b92f=1513400586");
	...
	public void retrievePaperUserRecords() {
		try {
			...
			param.add("paperId", "7640");
			param.add("recordId", "2041307");
			HttpEntity<MultiValueMap<String, String>> entity = new HttpEntity<>(param, headers);
			Map<String, Object> map = this.restTemplate.postForObject(url, entity, Map.class);
			List<Map<String, Object>> data = (List<Map<String, Object>>) map.get("data");
			File file = new File(PARENT, "retrievePaperUserRecords_1220.json");
	...
	public void readJsonFile() {
		try {
			List<Map<String, Object>> data = this.mapper.readValue(new File(PARENT, "retrievePaperUserRecords_1220.json"),
					List.class);
			...
			FileUtils.writeLines(new File(PARENT, "retrievePaperUserRecords_1220.txt"), lines);
			System.err.println("OK!");
		} catch (Exception e) {
			e.printStackTrace();
		}
