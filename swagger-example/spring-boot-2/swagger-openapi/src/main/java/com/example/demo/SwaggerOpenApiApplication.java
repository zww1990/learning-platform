...
@Slf4j
@AllArgsConstructor
public class SwaggerOpenApiApplication implements CommandLineRunner {

    public static void main(String[] args) {
        ApplicationContext context = SpringApplication.run(SwaggerOpenApiApplication.class, args);
