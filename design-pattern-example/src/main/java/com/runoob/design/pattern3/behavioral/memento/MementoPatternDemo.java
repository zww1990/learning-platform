package com.runoob.design.pattern3.behavioral.memento;

/**
 * @author Alienware <br>
 *         备忘录模式（Memento Pattern）保存一个对象的某个状态，以便在适当的时候恢复对象。备忘录模式属于行为型模式。<br>
 * <br>
 ...
 *         缺点：消耗资源。如果类的成员变量过多，势必会占用比较大的资源，而且每一次保存都会消耗一定的内存。 <br>
 *         使用场景： <br>
...
public class MementoPatternDemo {
	 ...
	 * 包含了要被恢复的对象的状态。Originator 创建并在 Memento 对象中存储状态。Caretaker 对象负责从 Memento
	 * 中恢复对象的状态。 MementoPatternDemo，我们的演示类使用 CareTaker 和 Originator
	 * 对象来显示对象的状态恢复。
	 */
