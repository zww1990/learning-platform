 ...
 *         缺点：没有接口，不能继承，与单一职责原则冲突，一个类应该只关心内部逻辑，而不关心外面怎么样来实例化。<br>
 *         使用场景： <br>
 *         1、要求生产唯一序列号。<br>
 ...
 *         防止多线程同时进入造成 instance 被多次实例化。<br>
 */
public class SingletonPatternDemo {
	/**
	 * 我们将创建一个 SingleObject 类。SingleObject 类有它的私有构造函数和本身的一个静态实例。 SingleObject
	 * 类提供了一个静态方法，供外界获取它的静态实例。SingletonPatternDemo，我们的演示类使用 SingleObject 类来获取
	 * SingleObject 对象。<br>
	 * <br>
