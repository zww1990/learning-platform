...
@Slf4j
public class VuetifyExampleApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext context = SpringApplication.run(VuetifyExampleApplication.class, args);
