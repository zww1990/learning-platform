...
@Slf4j
public class NaiveuiExampleApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext context = SpringApplication.run(NaiveuiExampleApplication.class, args);
