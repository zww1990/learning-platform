...
public class SimpleTests {
	...
	public void testBase64() {
		try {
			...
			System.err.println(Base64.getEncoder().encodeToString(content.getBytes()));
			System.err.println(Base64.getUrlEncoder().encodeToString(content.getBytes()));
			System.err.println(Base64.getEncoder().encodeToString(content.getBytes(StandardCharsets.UTF_8)));
			System.err.println(Base64.getUrlEncoder().encodeToString(content.getBytes(StandardCharsets.UTF_8)));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
