...
public class DefaultLoginPageGeneratingFilter extends GenericFilterBean {
	...
	private String generateLoginPageHtml(HttpServletRequest request, boolean loginError, boolean logoutSuccess) {
		String errorMsg = loginError ? getLoginErrorMessage(request) : "无效的凭据";
		...
		if (this.formLoginEnabled) {
			...
			sb.append("        <h2 class=\"form-signin-heading\">请登录</h2>\n");
		...
		if (this.oauth2LoginEnabled) {
			sb.append("<h2 class=\"form-signin-heading\">使用OAuth 2.0登录</h2>");
	...
	private String createRememberMe(String paramName) {
		...
		return "<p><input type='checkbox' name='" + paramName + "'/> 在这台电脑上记住我.</p>\n";
	}
	...
	private String createLogoutSuccess(boolean isLogoutSuccess) {
		...
		return "<div class=\"alert alert-success\" role=\"alert\">您已被注销</div>";
	}
