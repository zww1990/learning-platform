...
public class RabbitmqConfiguration {
	@Bean
	Demo1ConsumerListener demo1ConsumerListener() {
		return new Demo1ConsumerListener();
	}

	@Bean
	Demo2ConsumerListener demo2ConsumerListener() {
		return new Demo2ConsumerListener();
	}

	@Bean
	Demo3ConsumerListener demo3ConsumerListener() {
		return new Demo3ConsumerListener();
	}

	@Bean
	Demo4ConsumerListener demo4ConsumerListener() {
