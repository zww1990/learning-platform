...
/**
 * java调用hibernate-tools类库反向生成POJO、JPA DAO。
 *
 * @author ZhangWeiWei
 * @since 2018年9月28日, 下午2:24:19
 */
public class HibernateToolTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 设置POJO的包名
            configurationTask.setPackageName("com.example.demo.domain");
            // 设置hibernate的反向工程配置文件
            configurationTask.setRevEngFile(new Path(project, "hibernate-mysql-01\\src\\main\\resources\\hibernate.reveng.xml"));
            ...
            // 设置生成POJO文件目录
            javaExporterTask.setDestdir(new File(baseDir, "hibernate-mysql-01\\src\\main\\java"));
//			Hbm2DAOExporterTask daoExporterTask = (Hbm2DAOExporterTask) toolTask.createHbm2DAO();
            // 设置生成DAO文件目录
//			daoExporterTask.setDestdir(new File(baseDir, "hibernate-mysql-01\\src\\main\\java"));
            // 设置DAO的包名
//			Variable property = new Variable();
//			property.setKey("package-name");
//			property.setValue("com.example.demo.repository");
